...
public class AdicionarProdutoCarrinho extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        out.println("<br/>c&oacute;digo: <strong>" + prod.getId() + "</strong>");
        out.println("<br/>nome: <strong>" + prod.getId() + "</strong>");
        out.println("<br/>descri&ccedil;&atilde;o: <strong>" + prod.getId() + "</strong>");
        out.println("<br/>pre&ccedil;o: <strong>" + prod.getId() + "</strong>");
        out.println("<br/><img src='imagem/" + prod.getId() + "' />");
        out.println("</body>");
        out.println("</html>");
    }
}
